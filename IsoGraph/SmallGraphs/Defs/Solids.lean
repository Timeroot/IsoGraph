...
The thirteen Archimedean solids and their Catalan duals, as graphs.
-/
...
`truncatedTetrahedron`, in `IsoGraph/SmallGraphs/Defs/Named.lean`, is the smallest of the thirteen
