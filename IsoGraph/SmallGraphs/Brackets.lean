...
/-!
# Invariants squeezed between two brackets

Invariants known only up to a bracket — a lower bound and an upper bound that happen to meet, or
that do not.  Domination numbers, clique covers, edge chromatic numbers and automorphism counts of
the two-parameter families make up most of the file.
-/
