...
/-!
# Turán, friendship and crown graphs

Three more families with tables of their own — the Turán graphs, both in general and in the
balanced case, the friendship graphs, and the crown graphs — together with the independence and
matching numbers of the families introduced along with them, and the degree sequences of the line
graphs of the regular families.
-/
