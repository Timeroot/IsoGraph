...
Gluing two graphs along a distinguished vertex or edge, the proof that the result does not depend
on which vertex or edge was chosen, and the clique sums built on top.
-/
